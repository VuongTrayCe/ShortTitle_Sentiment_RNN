...
most_common = Counter(all_words).most_common(5998)
vocab = {'<PAD>': 0, '<UNK>': 1}
...
train_texts, test_texts, train_labels, test_labels = train_test_split(text_indices, labels,stratify = labels, test_size=0.2, random_state=42)
